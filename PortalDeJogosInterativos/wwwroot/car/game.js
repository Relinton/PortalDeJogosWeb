...
var obstacle = {
    ...
    type: [
        {
            name: 'CAR',
            src: 'car/images/car_green.png',
        },
        {
            name: 'HOLE',
            src: 'car/images/car_detailed.png',
        }
    ],
    cars: [
        'car/images/vehicles/mini_truck.png',
        'car/images/vehicles/car.png',
        'car/images/vehicles/taxi.png',
        'car/images/vehicles/ambulance.png'
    ],
...
var car = {
    ...
    height: 80,
    sprite: [
        'car/images/vehicles/car_police/1.png',
        'car/images/vehicles/car_police/2.png',
        'car/images/vehicles/car_police/3.png'
    ],
...
var properties = {
    sounds: {
        theme: 'car/sounds/C3 Racing - Traceillusion - Forth.mp3',
        colision: 'car/sounds/OOGAhorn.mp3'
    },
    scene: 'car/images/road.png',
    points: 'car/images/points.png',
    score: 'car/images/score.png',
    icon: 'car/images/icon.png',
    bandStreet: 'car/images/band_street.png',
    audio: {
        on: 'car/images/audio_on.png',
        off: 'car/images/audio_off.png'
    },
    font: {
        size: '18px',
        name: 'Consolas',
